    ...
    return (
        <div className='max-w-[1300px] mx-auto flex justify-between items-center p-4'>
            ...
            <div className='flex items-center'>
                <div className='cursor-pointer mr-5' onClick={() => setNav(!nav)}>
          ...
          <p className='p-2'>Pickup</p>
            ...
            {/* Search Input */}
            <div className='bg-gray-50 drop-shadow-lg rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
            ...
            {/* Cart button */}
            <button className='bg-purple-700 hover:bg-purple-900  border-none text-white hidden md:flex items-center py-2 rounded-full'>
